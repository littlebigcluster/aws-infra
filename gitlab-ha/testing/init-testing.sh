...
echo $SUBNETPUB
sed -i s/SUBNETPUB/$SUBNETPUB/ variables-testing.tf
...
echo $SUBNETPRIV
sed -i s/SUBNETPRIV/$SUBNETPRIV/ variables-testing.tf
...
sed -i s~VPC_CIDR~$VPC_CIDR~ variables-testing.tf
